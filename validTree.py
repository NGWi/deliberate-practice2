...
class Solution:
    def forbidConnections(
        ...
        """Takes a suggested connection, adds parent nodes to its entry in the forbiddenHash "database", or returns False if it is an already forbidden connection."""
        ...
        forbiddenHash[node] = forbiddenForThisNode + [otherNode]
